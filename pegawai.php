...
<style type="text/css">
  body{
    background-image: url("pegawai/img/1.png");
  }
</style>
...
<body>
          ...
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-center py-5 px-4 px-sm-5">
              <div class="brand-logo">
                <img src="main/img/info.ico" alt="logo">
              </div>
              <div class="center-text">
                <h4>LOGIN STAFF</h4>
              </div>
              <form method="POST" class="pt-3">
                <input type="hidden" name="hak_akses" value="Staf">
                <div class="form-group">
                  <input type="text" name="nik" class="form-control form-control-xs text-uppercase" placeholder="NIK" required autofocus>
                </div>
                <div class="form-group">
                  <input type="password" name="password" class="form-control form-control-xs text-uppercase" placeholder="Password" required>
                </div>
                <div class="mt-3">
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost:82/diskominfo/index.php">BATAL</a>
                </div>
              </form>
            </div>
          </div>
  ...
  <?php
    if(isset($_POST['login'])){
      ...
      $sql_login = "SELECT * FROM data_user WHERE nik='$nik' AND hak_akses='$hak_akses' AND password='$password'";
