						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST SURAT REKOMENDASI JAMINAN KESEHATAN DAERAH</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['kirim'])){
	...
	$sql = "INSERT INTO data_request_verifikasi (nik,scan_ktp,scan_kk,keperluan) VALUES ('$nik','$keperluan')";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=request_verifikasi">';
	  }
}
