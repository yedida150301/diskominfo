...
if(isset($_GET['id_request_verifikasi'])){
	...
	$tampil_nik = "SELECT * FROM data_request_verifikasi NATURAL JOIN data_user WHERE id_request_verifikasi=$id";
						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">UBAH REQUEST verifikasi</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['ubah'])){
    ...
    $sql = "UPDATE data_request_verifikasi SET
    keperluan='$keperluan',
    scan_ktp='$file_ktp',
    scan_kk='$file_kk' WHERE id_request_verifikasi=$id";
	...
	if($query){
		...
		echo '<meta http-equiv="refresh" content="3; url=?halaman=ubah_verifikasi">';
	  }
}
