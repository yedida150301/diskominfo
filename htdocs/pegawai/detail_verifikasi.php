...
<?php
	if(isset($_GET['id_request_verifikasi'])){
		$id_request_verifikasi=$_GET['id_request_verifikasi'];
		$sql = "SELECT * FROM data_request_verifikasi natural join data_user WHERE id_request_verifikasi='$id_request_verifikasi'";
							...
							<div class="col-md-7">
								<div class="card">
									<div class="card-header">
												...
												<a href="?halaman=sudah_acc_verifikasi" class="btn btn-info btn-border btn-round btn-sm">
													Batal
												</a>
												</div>
											<!-- <a href="cetak_verifikasi.php?id_request_verifikasi=<?php echo $id;?>" target="_blank" class="btn btn-info btn-border btn-round btn-sm">
												<span class="btn-label">
...
<?php
	if(isset($_POST['ubah'])){
		...
		if($query==1){
			$keterangan = $_POST['keterangan'];
			$ubah = "UPDATE data_request_verifikasi SET
		keterangan='$keterangan' WHERE id_request_verifikasi='$id_request_verifikasi'";
		...
		if($quey==1){
			...
			echo '<meta http-equiv="refresh" content="3; url=?halaman=detail_verifikasi">';
		  }
	}
?>