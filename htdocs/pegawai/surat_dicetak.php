											...
											<tbody>
												...
												<!-- <?php
															if(isset($_GET['id_request_verifikasi'])){
																$hapus = mysqli_query($konek,"DELETE FROM data_request_verifikasi WHERE id_request_verifikasi=$id");
																if($hapus){
