						...
						<form method="POST" enctype="multipart/form-data">
							<div class="card">
								<div class="card-header">
									<div class="card-title">FORM TAMBAH REQUEST VERIFIKASI</div>
								</div>
								<div class="card-body">
									<div class="row">
...
if(isset($_POST['kirim'])){
	...
	$sql = "INSERT INTO data_request_verifikasi (nik,scan_ktp,scan_kk,keperluan) VALUES ('$nik','$file_ktp','$file_kk','$keperluan')";
