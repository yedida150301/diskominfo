												...
												<tbody>
													...
													<tr>
														...
														<td>
															...
															<input type="checkbox" name="check[$i]" value="<?php echo $id_request_verifikasi;?>">
															<input type="submit" name="acc" class="btn btn-primary btn-sm" value="ACC">
															<div class="form-button-action">
																<a type="button" data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg" data-original-title="Cek Data" href="?halaman=detail_verifikasi&id_request_verifikasi=<?= $id_request_verifikasi;?>">
    ...
    if(isset($_POST['acc'])){
        if(isset($_POST['check']))
        {
                    foreach ($_POST['check'] as $value){
                        // echo $value;
                        $ubah = "UPDATE data_request_verifikasi set status =1 where id_request_verifikasi = $value"; 
