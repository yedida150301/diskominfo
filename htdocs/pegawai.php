        ...
        <div class="row w-100 mx-0">
          <div class="col-lg-4 mx-auto">
            <div class="auth-form-light text-left py-5 px-4 px-sm-5">
              ...
              <center><img src="main/img/info.ico" width="40" height="124" alt="logo"></center>
              </div>
              ...
              <form method="POST" class="pt-3">
                <div class="form-group">
                  <select name="hak_akses" id="" class="form-control text-uppercase">
                    ...
                    <?php
                        $SQL = "SELECT * FROM data_user WHERE hak_akses='Staf' or hak_akses='KADIS'";
                ...
                <div class="mb-2">
                  <a class="btn btn-block btn-danger btn-lg font-weight-medium auth-form-btn" href="http://localhost/index.php">BATAL</a>
                </div>
