...
<script src="js/sweetalert.min.js"></script> 
					...
					<div class="row">
										...
										<table id="add5" class="display table table-striped table-hover" >
											<thead>
												<tr>
													...
													<th>Status</th>
													<th>Keterangan</th>
													<th style="width: 10%">Lihat Berita</th>
											...
											<tbody>
												...
												<tr>
													...
													<td>
														<div class="form-button-action">
															<a href="?halaman=ubah_informasi&id_request_informasi=<?= $id_request_verifikasi;?>">
						...
						<div class="col-md-12">
							<div class="card">
								<div class="card-header">
									<div class="d-flex align-items-center">
										<h4 class="card-title">STATUS REQUEST VERIFIKASI BERITA</h4>
									</div>
								</div>
								<div class="card-body">
									<div class="table-responsive">
				...
				<?php
					...
					}elseif(isset($_GET['id_request_informasi'])){
