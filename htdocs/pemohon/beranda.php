					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Sebelum Anda Request verifikasi Lengkapi Biodata Anda, Klik Biodata Anda----------------------------------------------------------></h5>
							</div>
					...
					<div class="row mt--2">
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-primary">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">Informasi Berita</h6>
									</div>
									...
									<a href="?halaman=request_informasi" class="btn btn-primary btn-round btn-sm mb-3">
						...
						<div class="col-md-3 pr-md-0">
								<div class="card-pricing2 card-warning">
									<div class="pricing-header">
										<h6 class="fw-bold text-center text-uppercase">verifikasi Berita</h6>
									</div>
									<div class="price-value">
										<div class="value">
											<span class="currency"></span>
									...
									<a href="?halaman=request_verifikasi" class="btn btn-warning btn-round btn-sm mb-3"><span class="btn-label">
